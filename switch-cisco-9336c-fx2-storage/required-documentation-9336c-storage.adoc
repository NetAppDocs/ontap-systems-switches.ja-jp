...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージ スイッチのセットアップと設定に必要なスイッチとコントローラのドキュメントを確認してください。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチのドキュメント要件を確認する
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチをセットアップして ONTAP ストレージ ネットワークで設定するために必要なスイッチとコントローラーのドキュメントを確認してください。
...
Cisco Nexus 9336C-FX2 スイッチをセットアップするには、link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html["Cisco Nexus 9000 シリーズ スイッチのサポート"^]から次のドキュメントが必要です。
...
Cisco 9336-FX2 スイッチをNetAppキャビネットに設置するには、次のハードウェアドキュメントを参照してください。
