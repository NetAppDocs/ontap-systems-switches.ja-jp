...
summary: 新しいバージョンが利用可能な場合は、Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチの参照構成ファイル （RCF） をアップグレードしてください。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチの RCF をアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新しいバージョンの RCF が利用可能になった場合に、Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチの参照構成ファイル（RCF）をアップグレードします。
...
. ノード ストレージ ポートおよびストレージ シェルフ ポートに接続されているスイッチ ポートが *稼働中* であることを確認します。
+
[source, cli]
----
