...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチに NX-OS ソフトウェアをインストールまたはアップグレードします。 
---
= Cisco Nexus 9336C-FX2 ストレージスイッチへの NX-OS ソフトウェアのインストールまたはアップグレード
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージ スイッチに NX-OS ソフトウェアをインストールまたはアップグレードします。スイッチの設定や参照設定ファイル（RCF）のインストールを行うには、まず NX-OS をインストールする必要があります。
