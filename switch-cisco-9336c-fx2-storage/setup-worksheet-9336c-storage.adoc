...
summary: Cisco Nexus 9336C-FX2 または 9336C-FX2-T ストレージスイッチのケーブル配線ワークシートに記入し、ポート接続とサポートされているプラットフォーム構成を文書化します。 
---
...
[role="lead"]
Cisco Nexus 9336C-FX2 または 9336C-FX2-T ストレージスイッチのケーブル配線ワークシートに記入し、ポート接続とサポートされているプラットフォーム構成を文書化します。
