...
summary: ストレージ ネットワーク内の障害のある Cisco Nexus 9336C-FX2 または 9336C-FX2-T ストレージスイッチを交換します。これは無停止で実行できる手順です。 
---
...
[role="lead"]
ストレージ ネットワークの動作を中断することなく、障害のある Cisco Nexus 9336C-FX2 または 9336C-FX2-T ストレージスイッチをストレージ ネットワーク内で交換します。この無停止手順（NDU）では、交換用スイッチを準備し、ストレージ ネットワーク構成を復元します。
