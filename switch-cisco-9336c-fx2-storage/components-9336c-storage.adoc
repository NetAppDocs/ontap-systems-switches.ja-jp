...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチのコンポーネントと部品番号を特定し、ハードウェアの設置および継続的なメンテナンスをサポートします。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチのコンポーネントと部品番号を確認してください
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージスイッチのコンポーネントと部品番号を特定し、ハードウェアの設置および継続的なメンテナンスをサポートします。
...
X-NXA-PAC-1100W-PI2
 a| 
N9K-9336C AC 1100W PSU - ポート側吸気エアフロー
...
. 必要に応じて、新しいSmartアカウントを作成してください。詳細については、link:https://id.cisco.com/signin/register["新しいスマートアカウントを作成する"^]を参照してください。
. 既存のSmartアカウントへのアクセスをリクエストしてください。詳細については、link:https://id.cisco.com/oauth2/default/v1/authorize?response_type=code&scope=openid%20profile%20address%20offline_access%20cci_coimemberOf%20email&client_id=cae-okta-web-gslb-01&state=s2wvKDiBja__7ylXonWrq8w-FAA&redirect_uri=https%3A%2F%2Frpfa.cloudapps.cisco.com%2Fcb%2Fsso&nonce=qO6s3cZE5ZdhC8UKMEfgE6fbu3mvDJ8PTw5jYOp6z30["既存のスマートアカウントへのアクセスをリクエストする"^]を参照してください。
