...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージ スイッチのハードウェアをインストールするには、このワークフローに従ってください。 
---
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T ストレージ スイッチのハードウェアをインストールして構成するには、このワークフローに従ってください。
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["4"]link:cabling-considerations-9336c-storage.html["ケーブル配線と構成の考慮事項を確認する"]
[role="quick-margin-para"]
9336C-FX2 および 9336C-FX2-T スイッチを構成する前に、ケーブル接続と構成に関する考慮事項を確認してください。
