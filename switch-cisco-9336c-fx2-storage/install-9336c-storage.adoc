...
.次の手順
オプションとして、link:install-switch-and-passthrough-panel-9336c-storage.html["Cisco Nexus 9336C-FX2スイッチをネットアップキャビネットに設置します"] 。それ以外の場合は、link:setup-switch-9336c-storage.html["スイッチを設定します"] 。
