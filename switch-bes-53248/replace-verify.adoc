...
summary: Broadcom BES-53248クラスタスイッチのEFOSソフトウェアまたはRCFをアップグレードした後に、ONTAPクラスタネットワークの健全性を確認します。 
---
= Broadcom BES-53248クラスタスイッチのEFOSソフトウェアまたはRCFをアップグレードした後のONTAPクラスタネットワークを確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248クラスタスイッチでEFOSソフトウェアまたは参照構成ファイル（RCF）をアップグレードした後に、ONTAPクラスタネットワークの健全性を確認します。
