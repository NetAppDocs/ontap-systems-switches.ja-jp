...
summary: Broadcom BES-53248クラスタスイッチでSSHを有効にすると、イーサネットスイッチヘルスモニター（CSHM）機能とログ収集機能がサポートされます。 
---
= Broadcom BES-53248クラスタスイッチでSSHを有効にする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248クラスタスイッチでSSHを有効にすると、イーサネットスイッチヘルスモニター（CSHM）機能とログ収集機能がサポートされます。この手順では、SSHキーの生成とスイッチ上でのSSHアクセスの有効化について説明します。
