...
summary: BES-53248クラスタスイッチの設定後、および新しいライセンスの適用後に、リファレンス構成ファイルRCFをインストールできます。 
---
= リファレンス構成ファイル（RCF）をインストールします
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
BES-53248 クラスタ スイッチの設定後、および新しいライセンスの適用後に、RCF をインストールできます。
