...
summary: クラスタネットワーク内の故障した Broadcom BES-53248 クラスタスイッチを交換します。これは無停止手順です。 
---
= Broadcom BES-53248クラスタスイッチを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
クラスタネットワーク内で、クラスタの動作を中断することなく、故障した Broadcom BES-53248 クラスタスイッチを交換します。この無停止手順（NDU）では、交換用スイッチを準備し、故障したスイッチから接続を移行します。
