...
summary: Broadcom BES-53248クラスタスイッチの現在のスイッチ設定を消去して、工場出荷時のデフォルト設定にリセットします。 
---
= Broadcom BES-53248クラスタスイッチを工場出荷時のデフォルト設定にリセットする
:allow-uri-read: 


[role="lead"]
Broadcom BES-53248クラスタスイッチを工場出荷時のデフォルト設定にリセットするには、現在のスイッチ設定を消去し、スイッチを元の設定に復元します。
