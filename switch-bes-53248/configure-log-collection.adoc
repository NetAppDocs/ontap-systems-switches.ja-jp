...
[role="lead"]
ONTAP でスイッチ関連のログファイルを収集するために使用されるログ収集機能を有効にできます。

BES-53248クラスタスイッチCLIを使用して環境がセットアップ済みであることを確認します。



== ONTAP 9.8以降

次のコマンドを使用して、ログ収集機能を有効にします。
...
== ONTAP 9.5P15、9.6P11、9.7P8以降のパッチリリース
