...
NOTE: トランザクションキーをポートライセンスキーファイルと引き換えるには、link:https://support.broadcom.com/web/csg/license-generation["Broadcom 対応イーサネット スイッチのライセンス ポータル"^]ページ。ナレッジベースの記事を参照link:https://kb.netapp.com/on-prem/Switches/Broadcom-KBs/How_to_add_Additional_Port_Licensing_for_the_Broadcom_BES_53248_Switch["Broadcom BES-53248スイッチに追加ポートライセンスを追加する方法"^]詳細については、こちらをご覧ください。
