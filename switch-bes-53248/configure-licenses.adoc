...
summary: Broadcom BES-53248クラスタスイッチの基本モデルは、16個の10GbEまたは25GbEポートと2個の100GbEポートをサポートしています。スイッチの容量を拡張するには、追加のポートライセンスをインストールしてください。 
---
= Broadcom BES-53248クラスタスイッチのライセンスをインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248クラスタスイッチの基本モデルは、16個の10GbEまたは25GbEポートと2個の100GbEポートに対応するライセンスを取得しています。スイッチを拡張して、より多くの10GbEまたは25GbEクラスタポートをサポートするには、追加のポートライセンスをインストールしてください。
...
NOTE: ポートライセンスキーファイルのトランザクションキーを引き換えるには、link:https://support.broadcom.com/web/csg/license-generation["Broadcom 対応イーサネット スイッチのライセンス ポータル"^]を参照してください。詳細については、ナレッジベースの記事link:https://kb.netapp.com/on-prem/Switches/Broadcom-KBs/How_to_add_Additional_Port_Licensing_for_the_Broadcom_BES_53248_Switch["Broadcom BES-53248スイッチに追加ポートライセンスを追加する方法"^]を参照してください。
