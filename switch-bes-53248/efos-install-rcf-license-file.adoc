...
summary: 初期設定が完了したら、Broadcom BES-53248クラスタスイッチに参照構成ファイル（RCF）とライセンスファイルをインストールしてください。 
---
= Broadcom BES-53248クラスタスイッチにRCFファイルとライセンスファイルをインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Broadcom BES-53248クラスタスイッチに、参照構成ファイル（RCF）とライセンスファイルを一緒にインストールします。EFOS 3.12.0.1以降では、初期スイッチ設定完了後に両方のファイルをインストールできます。
...
* 現在のRCFは、link:https://mysupport.netapp.com/site/products/all/details/broadcom-cluster-switches/downloads-tab["Broadcom クラスタスイッチ"^]ページから入手できます。
...
.次の手順
RCFとライセンスファイルをインストールしたら、 link:configure-ssh.html["SSHを有効にする"]。
