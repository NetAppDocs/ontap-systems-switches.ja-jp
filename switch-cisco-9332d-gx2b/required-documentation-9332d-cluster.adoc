...
[role="lead"]
Cisco Nexus 9332D-GX2B スイッチのインストールについては、スイッチとコントローラの特定のドキュメントを確認して、9332D-GX2B スイッチと ONTAP クラスタをセットアップしてください。



== スイッチのドキュメント

Cisco Nexus 9332D-GX2B スイッチをセットアップするには、link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html["Cisco Nexus 9000 シリーズ スイッチのサポート"^]から次のドキュメントが必要です。
