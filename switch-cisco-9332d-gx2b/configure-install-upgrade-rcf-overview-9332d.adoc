...
summary: Cisco Nexus 9332D-GX2B スイッチへの RCF のインストールまたはアップグレードは、AFX 1K および AFX 2K システムのインストール、スイッチの交換、または新しいハードウェアや ONTAP バージョンのサポートを目的として実施します。 
---
= Cisco Nexus 9332D-GX2B スイッチへの RCF のインストールまたはアップグレードについて
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9332D-GX2B スイッチに参照構成ファイル（RCF）をインストールまたはアップグレードします。AFX 1K または AFX 2K システムのインストールまたはスイッチの交換用に新しい RCF をインストールするか、新しいハードウェアまたは ONTAP バージョンをサポートするために既存の RCF をアップグレードします。
...
.次の手順
RCF のインストールまたはアップグレードの概要を確認したら、必要に応じてlink:configure-install-rcf-9332d.html["RCFをインストールする"]またはlink:configure-upgrade-rcf-9332d.html["RCFをアップグレードする"]を実行できます。
