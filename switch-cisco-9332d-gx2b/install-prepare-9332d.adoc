...
summary: 新しい AFX 1K または AFX 2K システムの一部として Cisco Nexus 9332D-GX2B スイッチをインストールする準備をするには、スイッチのドキュメント、サポートされている RCF バージョン、および Smart Call Home の要件を確認してください。 
---
= AFX システムへの Cisco Nexus 9332D-GX2B スイッチのインストール準備
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
新しい AFX 1K または AFX 2K システムの一部として Cisco Nexus 9332D-GX2B スイッチをインストールする準備をするには、該当する Cisco スイッチのドキュメントを確認し、サポートされている RCF バージョンを理解し、Smart Call Home の設定を検討してください。
