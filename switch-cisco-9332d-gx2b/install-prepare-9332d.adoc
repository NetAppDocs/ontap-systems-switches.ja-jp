...
summary: 新しい AFX 1K または AFX 2K システムのインストールの一部として Cisco Nexus 9332D-GX2B スイッチをインストールする前に、該当する Cisco スイッチのドキュメントと ONTAP システムのドキュメントを確認し、AFX システムでサポートされている RCF バージョンを理解し、Smart Call Home の使用を検討することで、スイッチとそのインストールに関する事項を理解しておく必要があります。 
---
= スイッチの設置準備 - Cisco Nexus 9332D-GX2B
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
新しい AFX 1K または AFX 2K システムのインストールの一部として Cisco Nexus 9332D-GX2B スイッチをインストールする前に、該当する Cisco スイッチのドキュメントと ONTAP システムのドキュメントを確認し、AFX システムでサポートされている RCF バージョンを理解し、Smart Call Home の使用を検討することで、スイッチとそのインストールに関する事項を理解しておく必要があります。
...
* link:https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9332d-gx2b/cisco-nexus-9332d-gx2b-nx-os-mode-switch-hardware-installation-guide.html["Cisco Nexus 9332D-GX2B NX-OS モード スイッチ ハードウェア設置ガイド"^]
...
Smart Call Home に関する詳細情報は、link:configure-smart-call-9332d.html["スマートコールホームの設定"] のドキュメントをご参照ください。

.次の手順
スイッチの設置準備ができたら、link:install-switches-9332d.html["スイッチを取り付けます"]。
