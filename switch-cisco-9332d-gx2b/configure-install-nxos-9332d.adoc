...
summary: 新規の AFX 1K または AFX 2K システムのインストール、スイッチの交換、または工場出荷時設定へのリセットを行う場合は、Cisco Nexus 9332D-GX2B スイッチに NX-OS をインストールしてください。 
---
= Cisco Nexus 9332D-GX2B スイッチに NX-OS をインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新規の AFX 1K または AFX 2K システムのインストール、スイッチの交換、またはスイッチを工場出荷時のデフォルト設定にリセットする場合は、Cisco Nexus 9332D-GX2B スイッチに NX-OS をインストールします。
