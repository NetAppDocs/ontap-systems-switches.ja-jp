...
summary: NX-OS を Cisco Nexus 9332D-GX2B スイッチにインストールするのは、新しい AFX 1K または AFX 2K システムのインストール、スイッチの交換、またはスイッチを工場出荷時のデフォルト設定にリセットする場合です。 
---
= NX-OS をインストールする - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NX-OS を Cisco Nexus 9332D-GX2B スイッチにインストールするのは、新しい AFX 1K または AFX 2K システムのインストール、スイッチの交換、またはスイッチを工場出荷時のデフォルト設定にリセットする場合です。
...
+
** スイッチに現在のNetAppサポート対象バージョンが搭載されている場合、NX-OSをインストールする必要はありません。RCFをインストールする必要があります。link:configure-install-upgrade-rcf-overview-9332d.html["RCFの概要をインストールまたはアップグレードする"]から始めてください。
...
.次の手順
スイッチにNX-OSをインストールしたら、link:configure-install-upgrade-rcf-overview-9332d.html["RCFの概要をインストールまたはアップグレードする"]からRCFのインストールを開始します。
