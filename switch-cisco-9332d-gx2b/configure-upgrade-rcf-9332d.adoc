...
summary: Cisco Nexus 9332D-GX2B スイッチの RCF をアップグレードして、AFX 1K または AFX 2K システムで新しいハードウェア、新しい ONTAP バージョン、または新しい NX-OS バージョンをサポートします。 
---
= Cisco Nexus 9332D-GX2B スイッチの RCF をアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFX 1K または AFX 2K システムで新しいハードウェア、新しい ONTAP バージョン、または新しい NX-OS バージョンをサポートするために、Cisco Nexus 9332D-GX2B スイッチの参照構成ファイル （RCF） をアップグレードします。
