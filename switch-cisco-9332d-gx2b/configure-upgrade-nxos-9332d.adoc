...
summary: AFX 1K または AFX 2K システムで新しいハードウェアまたは新しい ONTAP バージョンをサポートするために、Cisco Nexus 9332D-GX2B スイッチの NX-OS をアップグレードします。 
---
= Cisco Nexus 9332D-GX2B スイッチの NX-OS をアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
AFX 1K または AFX 2K システムで新しいハードウェアまたは新しい ONTAP バージョンをサポートするために、Cisco Nexus 9332D-GX2B スイッチの NX-OS をアップグレードします。
...
最初のスイッチ（cs1）に NX-OS をインストールするには、NX-OS と EPLD の新しいバージョンをインストールして確認し、クラスタ上のすべてのポートの健全性を検証してから、2 番目のスイッチ（cs2）でこれらの手順を繰り返します。
