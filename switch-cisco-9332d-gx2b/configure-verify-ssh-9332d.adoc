...
summary: Cisco Nexus 9332D-GX2B スイッチで SSH が有効になっていることを確認し、イーサネットスイッチヘルスモニター（CSHM）とログ収集をサポートします。 
---
= Cisco Nexus 9332D-GX2B スイッチでログ収集のための SSH を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9332D-GX2B スイッチで SSH が有効になっていることを確認し、イーサネットスイッチヘルスモニター（CSHM）およびログ収集機能をサポートします。
