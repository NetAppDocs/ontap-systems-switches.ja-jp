...
summary: Cisco Nexus 9336C-FX2 または 9336C-FX2-T クラスタスイッチのケーブル配線ワークシートに、ポート接続とサポートされているプラットフォーム構成を記録します。 
---
= Cisco Nexus 9336C-FX2 または 9336C-FX2-T クラスタスイッチの配線ワークシートを確認してください
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 または 9336C-FX2-T クラスタスイッチのケーブル配線ワークシートに、ポート接続とサポートされているプラットフォーム構成を記録します。
