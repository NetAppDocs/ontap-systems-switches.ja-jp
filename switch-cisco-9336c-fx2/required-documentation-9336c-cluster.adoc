...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのセットアップと設定に必要なスイッチとコントローラのドキュメントを確認してください。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのドキュメント要件を確認する
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチをセットアップして ONTAP クラスタに構成するために必要なスイッチとコントローラーのドキュメントを確認してください。
...
Cisco Nexus 9336C-FX2および9336C-FX2-Tスイッチを設定するには、link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html["Cisco Nexus 9000 シリーズ スイッチのサポート"^]の以下のドキュメントが必要です。
