...
summary: SSH と SSH キーが Cisco Nexus 9336C-FX2 クラスタスイッチで有効になっていることを確認し、CSHM とログ収集をサポートします。 
---
= Cisco Nexus 9336C-FX2 クラスタスイッチのSSH構成を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチで SSH および SSH キーが有効になっていることを確認し、イーサネットスイッチヘルスモニター（CSHM）およびログ収集機能をサポートします。
