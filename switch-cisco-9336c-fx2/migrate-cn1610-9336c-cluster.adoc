...
summary: クラスタの動作を中断することなく、NetApp CN1610 クラスタスイッチを Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチに移行します。 
---
= NetApp CN1610 クラスタースイッチから Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタースイッチへの移行
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
既存の NetApp CN1610 クラスタースイッチを、クラスターの動作を中断することなく Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタースイッチに移行します。
...
サポートされているポートとその構成の詳細については、link:https://hwu.netapp.com/["Hardware Universe"^]を参照してください。スイッチの設置要件の詳細については、link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["HWU にない機器をインストールするには、どのような追加情報が必要ですか?"^]を参照してください。
