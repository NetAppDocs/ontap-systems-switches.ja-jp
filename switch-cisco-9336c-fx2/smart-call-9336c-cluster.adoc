...
summary: Cisco Nexus 9336C-FX2 クラスタスイッチの Smart Call Home の要件と構成オプションを確認してください。 
---
= Cisco Nexus 9336C-FX2 クラスタスイッチの Smart Call Home 要件を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 クラスタスイッチで Smart Call Home を設定するための要件を確認し、重要なシステムイベントに関する自動メール通知を有効にしてください。
