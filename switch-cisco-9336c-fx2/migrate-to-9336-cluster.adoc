...
summary: 古い Cisco クラスタースイッチを、クラスターの動作を中断することなく Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタースイッチに移行します。 
---
= 古い Cisco スイッチから Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチへの移行
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
古い Cisco クラスタースイッチを、クラスターの動作を中断することなく Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタースイッチに移行します。
