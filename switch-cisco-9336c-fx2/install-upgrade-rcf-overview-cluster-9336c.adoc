...
summary: 初期設定後または既存の RCF をアップグレードする際に、Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチに参照構成ファイル （RCF） をインストールまたはアップグレードします。 
---
= Cisco Nexus 9336C-FX2および9336C-FX2-Tクラスタスイッチへの RCF のインストールまたはアップグレードについて
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
参照構成ファイル（RCF）を Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチに初期設定後にインストールするか、新しいバージョンが利用可能になったときに RCF バージョンをアップグレードしてください。
...
.利用可能なRCF構成
以下の表は、さまざまな構成で使用可能なRCFについて説明しています。ご使用の構成に適したRCFを選択してください。詳細については、link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Ciscoイーサネット スイッチ"^]を参照してください。
...
|===
.利用可能なRCF
以下の表は、9336C-FX2および9336C-FX2-Tスイッチで使用可能なRCFの一覧です。ご使用の構成に適したRCFバージョンを選択してください。詳細については、link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Ciscoイーサネット スイッチ"^]を参照してください。
...
| RCF name 
 ...
 a| 
クラスター HA ブレイクアウト RCF 1._xx_



 a| 
クラスタ HA ストレージ RCF 1._xx_
...
* link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/products-installation-guides-list.html["Cisco Nexus 9000 シリーズ スイッチ"^]
+
...
利用可能なRCF構成の詳細については、link:configure-software-overview-9336c-cluster.html["ソフトウェアインストールワークフロー"]を参照してください。
