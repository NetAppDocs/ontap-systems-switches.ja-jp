...
summary: ONTAP 環境に Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチをインストールして設定するには、このワークフローに従ってください。 
---
...
[role="lead"]
ONTAP 環境に Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチをインストールして設定するには、このワークフローに従ってください。これらのスイッチは Cisco Nexus 9000 プラットフォームの一部であり、3 ノード以上の ONTAP クラスタをサポートします。
