...
summary: 参照構成ファイル（RCF）を Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチの初期設定後にインストールして、ポート割り当て、VLAN、およびネットワーク設定を構成します。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチへの RCF のインストール
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
初期設定後に、Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチに参照構成ファイル（RCF）をインストールします。RCF は、クラスタ運用に必要なポート割り当て、VLAN、およびネットワーク設定を定義します。
