...
summary: クラスタネットワーク内の障害のある Cisco Nexus 9336C-FX2 または 9336C-FX2-T クラスタスイッチを交換します。この手順は無停止で実行できます。 
---
...
[role="lead"]
クラスタの動作を中断することなく、障害のある Cisco Nexus 9336C-FX2 または 9336C-FX2-T クラスタスイッチをクラスタネットワーク内で交換します。この無停止手順（NDU）では、交換用スイッチを準備し、障害が発生したスイッチから接続を移行します。
