...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのコンポーネントと部品番号を特定し、ハードウェアの設置および継続的なメンテナンスをサポートします。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのコンポーネントと部品番号を確認してください
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのコンポーネントと部品番号を特定し、ハードウェアの設置および継続的なメンテナンスをサポートします。
