...
summary: NX-OS ソフトウェアとリファレンス構成ファイル（RCF）をインストールする前に、Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチを準備します。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチへの NX-OS ソフトウェアと RCF のインストールの準備
:allow-uri-read: 


[role="lead"]
NX-OSソフトウェアとリファレンス構成ファイル（RCF）をインストールする前に、Cisco Nexus 9336C-FX2および9336C-FX2-Tクラスタスイッチを準備してください。スイッチがONTAPクラスタで動作するためには、NX-OSとRCFをインストールする必要があります。
