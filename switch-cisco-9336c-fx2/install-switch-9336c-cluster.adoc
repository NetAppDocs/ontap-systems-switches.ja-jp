...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチをセットアップおよび設定して、ネットワーク運用に向けて準備します。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのインストール
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチをセットアップおよび設定して、ネットワーク運用に向けて準備します。
...
NetAppシステムキャビネット内のCisco Nexus 9336C-FX2
 a| 
スイッチをNetAppキャビネットに設置する手順については、『Cisco Nexus 9336C-FX2クラスタスイッチとパススルーパネルのNetAppキャビネットへの設置』ガイドを参照してください。
