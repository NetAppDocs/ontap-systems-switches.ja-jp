...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのハードウェアをインストールするには、このワークフローに従ってください。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのハードウェアインストールワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチのハードウェアをインストールおよび設定するには、このワークフローに従ってください。
