...
summary: Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチに NX-OS ソフトウェアをインストールまたはアップグレードします。 
---
= Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチへの NX-OS ソフトウェアのインストールまたはアップグレード
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9336C-FX2 および 9336C-FX2-T クラスタスイッチに NX-OS ソフトウェアをインストールまたはアップグレードします。スイッチの設定や参照設定ファイル（RCF）のインストールを行うには、まず NX-OS をインストールする必要があります。

始める前に、以下の手順を完了してください。link:install-nxos-overview-9336c-cluster.html["NX-OSとRCFのインストールの準備"] 。


NOTE: NetApp では、最初に ONTAP ソフトウェアのアップグレードを完了してから、スイッチのソフトウェアアップグレードを実行することをお勧めします。
