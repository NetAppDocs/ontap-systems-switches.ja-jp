...
summary: イーサネットスイッチのヘルスモニタリングが正しく設定され、スイッチで正常に動作していることを確認してください。 
---
= イーサネットスイッチのヘルスモニタリングの設定を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
イーサネットスイッチヘルスモニター（CSHM）は、検出したネットワークスイッチを自動的に監視しようとしますが、スイッチが正しく設定されていない場合は、監視が自動的に行われない可能性があります。ヘルスモニターがスイッチを監視するように正しく設定されていることを確認してください。
