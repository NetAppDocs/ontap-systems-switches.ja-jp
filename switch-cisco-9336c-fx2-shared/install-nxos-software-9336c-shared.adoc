...
summary: NX-OS ソフトウェアを Cisco Nexus 9336C-FX2 共有スイッチにインストールして、共有クラスタおよびストレージ運用に対応できるよう準備します。 
---
= Cisco Nexus 9336C-FX2共有スイッチにNX-OSソフトウェアをインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NX-OS ソフトウェアを Cisco Nexus 9336C-FX2 共有スイッチにインストールして、共有クラスタおよびストレージ運用に対応できるよう準備します。
