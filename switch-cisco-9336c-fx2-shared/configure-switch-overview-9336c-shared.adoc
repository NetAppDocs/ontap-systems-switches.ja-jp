...
summary: このワークフローに従って、ONTAP 環境に Cisco Nexus 9336C-FX2 共有スイッチをインストールおよび設定します。 
---
...
[role="lead"]
このワークフローに従って、ONTAP 環境に Cisco Nexus 9336C-FX2 共有スイッチをインストールおよび設定します。共有スイッチは、共有参照構成ファイル（RCF）を使用して、クラスタ機能とストレージ機能を統合します。
