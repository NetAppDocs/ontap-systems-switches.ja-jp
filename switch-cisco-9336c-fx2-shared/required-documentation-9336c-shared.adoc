...
summary: Cisco Nexus 9336C-FX2 共有スイッチのセットアップと設定に必要なスイッチおよびコントローラのドキュメントを確認してください。 
---
= Cisco Nexus 9336C-FX2 共有スイッチのドキュメント要件を確認する
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cisco Nexus 9336C-FX2 共有スイッチをセットアップし、ONTAP 環境で設定するために必要なスイッチとコントローラーのドキュメントを確認してください。
