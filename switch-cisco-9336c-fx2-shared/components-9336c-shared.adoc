...
summary: Cisco Nexus 9336C-FX2 共有スイッチのコンポーネントと部品番号を特定し、ハードウェアの設置および継続的なメンテナンスをサポートします。 
---
= Cisco Nexus 9336C-FX2共有スイッチのコンポーネントと部品番号を確認してください
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Cisco Nexus 9336C-FX2 共有スイッチのコンポーネントと部品番号を特定し、ハードウェアの設置および継続的なメンテナンスをサポートします。
...
| X-NXA-PAC-1100W-PI2 | N9K-9336C AC 1100W PSU - ポート側吸気エアフロー 
