...
summary: このワークフローに従って、Cisco Nexus 9336C-FX2 共有スイッチに NX-OS ソフトウェアと RCF をインストールしてください。 
---
...
[role="lead"]
このワークフローに従って、Cisco Nexus 9336C-FX2 共有スイッチに NX-OS ソフトウェアと参照構成ファイル（RCF）をインストールしてください。
