...
summary: NVIDIA SN2100クラスタスイッチにCumulus LinuxとRCFをインストールするには、このワークフローに従ってください。 
---
= NVIDIA SN2100クラスタスイッチのソフトウェアインストールワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
このワークフローに従って、NVIDIA SN2100クラスタスイッチにCumulus Linuxと参照構成ファイル（RCF）をインストールしてください。
