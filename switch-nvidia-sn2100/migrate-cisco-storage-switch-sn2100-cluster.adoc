...
summary: 古い Cisco ストレージスイッチから NVIDIA SN2100 ストレージスイッチへ、ストレージ ネットワークの運用を中断することなく移行します。 
---
= Cisco ストレージスイッチから NVIDIA SN2100 ストレージスイッチへの移行
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
古い Cisco ストレージスイッチから NVIDIA SN2100 ストレージスイッチへ、ストレージ ネットワークの運用を中断することなく移行します。
...
古い Cisco スイッチを NVIDIA SN2100 ストレージスイッチに交換する際には、特定の構成情報、ポート接続、およびケーブル配線の要件を把握しておく必要があります。link:configure-overview-sn2100-cluster.html["NVIDIA SN2100スイッチのインストールと構成の概要"]を参照してください。
