...
summary: スイッチが ONIE モードで動作しているときに、NVIDIA SN2100 クラスタスイッチに Cumulus Linux をインストールします。 
---
= NVIDIA SN2100クラスタスイッチにCumulus LinuxをONIEモードでインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
スイッチが ONIE モードで動作しているときに、NVIDIA SN2100 クラスタスイッチに Cumulus Linux （CL） をインストールします。


NOTE: Cumulus Linux (CL) OSは、スイッチがONIEまたはCumulus Linuxを実行しているときにインストールできます（link:install-cumulus-mode-sn2100-cluster.html["Cumulusモードでインストール"]を参照）。
