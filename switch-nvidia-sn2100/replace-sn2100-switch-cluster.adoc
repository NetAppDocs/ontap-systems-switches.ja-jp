...
summary: クラスタネットワーク内の障害のある NVIDIA SN2100 クラスタスイッチを交換します。これは無停止の手順です。 
---
= NVIDIA SN2100クラスタスイッチの交換
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
クラスタの動作を中断することなく、クラスタネットワーク内の障害のある NVIDIA SN2100 クラスタスイッチを交換します。この無停止手順（NDU）では、交換用スイッチを準備し、故障したスイッチから接続を移行します。
