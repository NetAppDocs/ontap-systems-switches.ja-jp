...
summary: 既存の NetApp CN1610 クラスタースイッチを NVIDIA SN2100 クラスタースイッチに、クラスターの動作を中断することなく移行します。 
---
= NetApp CN1610クラスタースイッチからNVIDIA SN2100クラスタースイッチへの移行
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
既存の NetApp CN1610 クラスタースイッチを NVIDIA SN2100 クラスタースイッチに、クラスターの動作を中断することなく移行します。
...
NetApp CN1610クラスタスイッチをNVIDIA SN2100クラスタスイッチに交換する際には、特定の構成情報、ポート接続、およびケーブル配線要件を把握しておく必要があります。link:configure-overview-sn2100-cluster.html["NVIDIA SN2100スイッチのインストールと構成の概要"]を参照してください。
...
サポートされているポートとその構成の詳細については、link:https://hwu.netapp.com/["Hardware Universe"^]を参照してください。
