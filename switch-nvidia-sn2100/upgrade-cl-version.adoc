...
summary: NVIDIA SN2100 クラスタースイッチの Cumulus Linux バージョンをアップグレードして、ONTAP との互換性を維持し、最新のソフトウェア機能にアクセスします。 
---
= NVIDIA SN2100クラスタスイッチの Cumulus Linux をアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NVIDIA SN2100 クラスタースイッチの Cumulus Linux バージョンをアップグレードして、ONTAP との互換性を維持し、最新のソフトウェア機能にアクセスします。
...
詳細については、link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-510/Installation-Management/Installing-a-New-Cumulus-Linux-Image/["新しいCumulus Linuxイメージのインストール"^]を参照してください。
...
----
+
詳細については、link:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["NVIDIAユーザーアカウント"^]を参照してください。
...
----
+
詳細についてはlink:https://docs.nvidia.com/networking-ethernet-software/cumulus-linux-54/System-Configuration/Authentication-Authorization-and-Accounting/User-Accounts/["NVIDIAユーザーアカウント"^]を参照してください。
