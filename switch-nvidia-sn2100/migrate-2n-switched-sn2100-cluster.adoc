...
IMPORTANT: link:cabling-considerations-sn2100-cluster.html["ケーブル配線と構成の考慮事項を確認する"]注意事項および詳細については、こちらを参照してください。link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe- スイッチ"^]には、ケーブル配線に関する詳細情報も含まれています。
