...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["2"]link:cabling-considerations-sn2100-cluster.html["ケーブル配線と構成に関するガイドラインを確認します。"]
[role="quick-margin-para"]
