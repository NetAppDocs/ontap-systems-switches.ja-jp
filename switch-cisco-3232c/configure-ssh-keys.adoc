...
summary: SSH と SSH キーが Cisco Nexus 3232C クラスタスイッチで有効になっていることを確認し、CSHM とログ収集をサポートします。 
---
= Cisco Nexus 3232C クラスタスイッチの SSH 構成を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
SSH と SSH キーが Cisco Nexus 3232C クラスタスイッチで有効になっていることを確認し、イーサネットスイッチヘルスモニター（CSHM）およびログ収集機能をサポートします。
