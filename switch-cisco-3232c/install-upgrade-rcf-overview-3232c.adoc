...
|===
.利用可能なRCF
次の表に、3232Cスイッチで使用可能なRCFを示します。構成に適したRCFバージョンを選択してください。詳細については、link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Ciscoイーサネット スイッチ"^]を参照してください。
...
.次の手順
RCFのインストールまたはRCFのアップグレード手順の概要を確認した後、link:install-rcf-software-3232c.html["RCFをインストールする"]またはlink:upgrade-rcf-software-3232c.html["RCFをアップグレードする"]必要に応じて。
