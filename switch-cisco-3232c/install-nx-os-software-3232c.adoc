...
----
====
. NX-OSバージョン9.3(11)にアップグレードする場合は、EPLDイメージをアップグレードし、スイッチをもう一度リブートする必要があります `golden`。それ以外の場合は、手順12に進みます。
+
詳細については、を参照してください https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLDアップグレードリリースノート、リリース9.3(11)"^]。
...
.次の手順
link:install-rcf-3232c.html["RCF構成ファイルをインストールします"]です。
