...
+
詳細については、link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD アップグレード リリース ノート、リリース 9.3(11)"^]を参照してください。
...
.次の手順
NX-OSソフトウェアをインストールしたら、 link:install-upgrade-rcf-overview-3232c.html["参照構成ファイル (RCF) をインストールまたはアップグレードする"]。
