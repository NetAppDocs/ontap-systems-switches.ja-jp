...
summary: Cisco Nexus 3232C クラスタスイッチに NX-OS ソフトウェアをインストールして、クラスタ運用に備えます。 
---
= Cisco Nexus 3232C クラスタスイッチに NX-OS ソフトウェアをインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3232C クラスタスイッチに NX-OS ソフトウェアをインストールして、クラスタ運用に備えます。
...
+
詳細については、link:https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLDアップグレードリリースノート、リリース9.3(11)"^]を参照してください。
...
.次の手順
NX-OS ソフトウェアをインストールしたら、link:install-upgrade-rcf-overview-3232c.html["参照構成ファイル (RCF) をインストールまたはアップグレードする"]できます。
