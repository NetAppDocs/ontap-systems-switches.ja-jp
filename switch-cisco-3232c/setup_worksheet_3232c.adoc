...
summary: Cisco Nexus 3232C クラスタスイッチのケーブル配線ワークシートに必要事項を記入し、ポート接続とサポートされているプラットフォーム構成を記録してください。 
---
= Cisco Nexus 3232C ケーブル配線ワークシートに記入する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3232C クラスタスイッチのケーブル配線ワークシートに必要事項を記入し、ポート接続とサポートされているプラットフォーム構成を記録してください。

サンプル配線ワークシートには、スイッチからコントローラへの推奨ポート割り当ての例が示されています。空白のワークシートには、クラスターの設定に使用できるテンプレートが用意されています。

各スイッチは、1つの100GbEポート、40GbEポート、または4 x 10GbEポートとして構成できます。
...
31
 a| 
100GbE ISL スイッチ B ポート 31
 a| 
31
 a| 
100GbE ISL スイッチAポート31へ
...
32
 a| 
100GbE ISL スイッチ B ポート 32
 a| 
32
 a| 
100GbE ISL スイッチ A ポート 32
...
|===
.次の手順
ケーブル配線ワークシートを完了したら、link:install-switch-3232c.html["スイッチをインストールする"]。
