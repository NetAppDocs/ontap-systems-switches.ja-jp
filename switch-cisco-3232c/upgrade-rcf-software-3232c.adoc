...
summary: クラスタスイッチヘルスモニター（CSHM）およびログ収集機能を使用する場合、SSHが必要です。Cisco 3232cクラスタスイッチでSSHを有効にするには、まずSSHキーを生成してからSSHを有効にします。 
---
...
. 以下の転送プロトコル（FTP、TFTP、SFTP、SCP）のいずれかを使用して、RCFをスイッチcs2のbootflashにコピーします。Ciscoコマンドの詳細については、link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 シリーズ NX-OS コマンド リファレンス"^]の適切なガイドを参照してください。
+
.例を表示
[%collapsible]
====
...
+
Ciscoコマンドの詳細については、link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 シリーズ NX-OS コマンド リファレンス"^]の適切なガイドを参照してください。
