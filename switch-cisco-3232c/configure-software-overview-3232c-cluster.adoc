...
summary: このワークフローに従って、Cisco Nexus 3232C クラスタスイッチに NX-OS ソフトウェアと RCF をインストールしてください。 
---
...
[role="lead"]
このワークフローに従って、Cisco Nexus 3232C クラスタスイッチに NX-OS ソフトウェアと参照構成ファイル（RCF）をインストールしてください。
...
[role="quick-margin-para"]
Cisco NX-OSソフトウェアおよびリファレンス構成ファイル（RCF）は、Cisco 3232Cクラスタスイッチにインストールする必要があります。
