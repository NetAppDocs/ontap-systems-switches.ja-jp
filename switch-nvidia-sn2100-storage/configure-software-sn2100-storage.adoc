...
summary: NVIDIA SN2100ストレージスイッチにCumulus LinuxとRCFをインストールするには、このワークフローに従ってください。 
---
...
[role="lead"]
このワークフローに従って、NVIDIA SN2100ストレージスイッチにCumulus Linuxと参照構成ファイル（RCF）をインストールしてください。
