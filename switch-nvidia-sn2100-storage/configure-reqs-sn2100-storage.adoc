...
summary: NVIDIA SN2100 ストレージスイッチの設置またはアップグレードを行う前に、構成要件を確認してください。 
---
= NVIDIA SN2100 ストレージスイッチの構成要件を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NVIDIA SN2100 ストレージスイッチの設置またはアップグレードを行う前に、構成要件を確認してください。
...
ケーブル配線のガイドラインについては、link:cabling-considerations-sn2100-storage.html["ケーブル配線と構成に関する考慮事項"]を参照してください。
...
* Cumulus Linux (CL) OS バージョン 4.4.3。最新の互換性情報については、link:https://mysupport.netapp.com/site/info/nvidia-cluster-switch["NVIDIAイーサネットスイッチ"^]を参照してください。
