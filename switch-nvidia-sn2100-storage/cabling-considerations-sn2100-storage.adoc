...
summary: 導入前に、NVIDIA SN2100ストレージスイッチのケーブル配線と構成に関する考慮事項を確認してください。 
---
= NVIDIA SN2100 ストレージスイッチのケーブル配線と構成に関する考慮事項を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
導入前に、NVIDIA SN2100ストレージスイッチのケーブル配線と構成に関する考慮事項を確認してください。
...
====
.次の手順
ケーブル配線と構成要件を確認したら、link:install-cable-shelves-sn2100-storage.html["NS224シェルフをスイッチ接続ストレージとしてケーブル接続する"] 。
