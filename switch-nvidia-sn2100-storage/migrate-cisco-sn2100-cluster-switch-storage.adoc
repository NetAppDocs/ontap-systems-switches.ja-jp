...
[role="lead"]
Cisco クラスタースイッチから NVIDIA SN2100 クラスタースイッチへ、クラスターの動作を中断することなく移行します。移行を開始する前に、構成情報、ポート接続、およびケーブル配線の要件を確認してください。
...
* サポートされているポートとその設定の詳細については、link:https://hwu.netapp.com/["Hardware Universe"^]を参照してください。
