...
summary: このリリースには、ログ監視用の SNMPv3 のサポートが含まれています。 
---
= スイッチログ収集用にSNMPv3を構成する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
スイッチ ログ収集とスイッチ ヘルス モニタリング (SHM) をサポートする SNMPv3 を構成するには、次の手順に従ってください。
...
次のコマンドは、SHM を使用して SNMPv3 ユーザー名を確立します。
