...
summary: NVIDIA SN2100ストレージスイッチのイーサネットスイッチヘルスモニター（CSHM）構成ファイルをインストールして、ONTAPでスイッチの健全性監視を有効にします。 
---
= NVIDIA SN2100 ストレージスイッチ用イーサネットスイッチヘルスモニター構成ファイルのインストール
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
NVIDIA SN2100ストレージスイッチのイーサネットスイッチヘルスモニター（CSHM）構成ファイルをインストールして、ONTAPでスイッチの状態監視を有効にします。対応機種は以下のとおりです。
