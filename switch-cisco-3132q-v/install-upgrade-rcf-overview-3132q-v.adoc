...
|===
.利用可能なRCF
次の表は、3132Q-V スイッチで使用可能な RCF を示しています。構成に適した RCF バージョンを選択します。見るlink:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Ciscoイーサネット スイッチ"^]詳細についてはこちらをご覧ください。
