...
. link:install-cisco-nexus-3232c.html["Cisco Nexus 3132Q-Vクラスタスイッチをネットアップキャビネットに設置します"]。Cisco Nexus 3132Q-Vスイッチとパススルーパネルを、スイッチに付属の標準ブラケットを使用してネットアップキャビネットに設置します。
