...
summary: SSH と SSH キーが Cisco Nexus 3132Q-V クラスタスイッチで有効になっていることを確認し、CSHM およびログ収集をサポートします。 
---
= Cisco Nexus 3132Q-V クラスタスイッチのSSH構成を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
SSH と SSH キーが Cisco Nexus 3132Q-V クラスタスイッチで有効になっていることを確認し、イーサネットスイッチヘルスモニター（CSHM）およびログ収集機能をサポートします。
