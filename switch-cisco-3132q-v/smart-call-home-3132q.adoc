...
summary: Cisco Nexus 3132Q-V クラスタスイッチの Smart Call Home の要件と構成オプションを確認してください。 
---
= Cisco Nexus 3132Q-V クラスタスイッチの Smart Call Home 要件を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3132Q-V クラスタスイッチで Smart Call Home を設定するための要件を確認し、重大なシステムイベントに関する自動メール通知を有効にしてください。
