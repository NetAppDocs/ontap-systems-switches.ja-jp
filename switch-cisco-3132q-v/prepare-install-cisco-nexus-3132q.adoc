...
summary: Cisco NX-OSソフトウェアおよびリファレンス構成ファイル（RCF）をCisco Nexus 3132Q-Vクラスタ スイッチにインストールする必要があります。 
---
= NX-OSソフトウェアとリファレンス構成ファイルのインストール準備
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.次の手順
NX-OSソフトウェアとRCFをインストールする準備ができたら、 link:install-nx-os-software-3132q-v.html["NX-OSソフトウェアをインストールする"]。
