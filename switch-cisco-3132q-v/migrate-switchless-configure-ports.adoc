...
summary: 2ノードのスイッチレスクラスタから Cisco Nexus 3132Q-V クラスタスイッチへの移行用にポートを設定します。 
---
= スイッチレスクラスタから Cisco Nexus 3132Q-V クラスタスイッチへの移行のためのポートを設定する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3132Q-V クラスタスイッチを使用して、2ノードのスイッチレスクラスタから2ノードのスイッチドクラスタへの移行用にポートを設定します。
