...
summary: Cisco Nexus 3132Q-V クラスタスイッチを設定する前に、設定の概要を確認してください。 
---
= Cisco Nexus 3132Q-V スイッチのハードウェアインストールワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
3132Q-V クラスタスイッチのハードウェアをインストールおよび設定するには、次の手順に従ってください。
