...
summary: 障害のある Cisco Nexus 3132Q-V クラスタスイッチを交換します。これは無停止の手順です。 
---
...
[role="lead"]
クラスタの動作を中断することなく、障害のある Cisco Nexus 3132Q-V クラスタスイッチを交換します。この無停止手順（NDU）では、交換用スイッチを準備し、障害のあるスイッチから接続を移行します。
