...
* ノードは n1 、 n2 、 n3 、 n4 です。- この手順の例では 4 つのノードを使用します。2 つのノードは 4 つの 10GB クラスタ インターコネクト ポート（ e0a 、 e0b 、 e0c 、 e0d ）を使用します。他の 2 つのノードは 2 つの 40GB クラスタ インターコネクト ポート（ e4a と e4e ）を使用します。プラットフォームの実際のクラスタ ポートについては、 link:https://hwu.netapp.com/["Hardware Universe"^] を参照してください。
