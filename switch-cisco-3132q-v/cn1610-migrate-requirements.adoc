...
* https://mysupport.netapp.com/site/products/all/details/netapp-cluster-switches/docs-tab["NetApp CN1601 / CN1610 の概要 ページ"^]
* https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco Ethernet Switch 概要 ページ"^]
