...
summary: Cisco Nexus 3132Q-V クラスタスイッチをインストールして、ネットワーク運用に向けて準備します。 
---
= Cisco Nexus 3132Q-V クラスタスイッチのインストール
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3132Q-V クラスタスイッチをインストールして、ネットワーク運用に向けて準備します。
...
* link:setup_worksheet_3132q.html["配線ワークシート"]が完了しました。
...
NetAppシステムキャビネット内のCisco Nexus 9336C-FX2
 a| 
スイッチをNetAppキャビネットに設置する手順については、『Cisco Nexus 3132Q-VクラスタスイッチとパススルーパネルのNetAppキャビネットへの設置』ガイドを参照してください。
...
.次の手順
オプションで、link:install-cisco-nexus-3132qv.html["Cisco Nexus 3132Q-V スイッチを NetApp キャビネットに設置する"]。または、link:cabling-considerations-3132q-v.html["ケーブル配線と構成を確認する"]要件を満たすこともできます。
