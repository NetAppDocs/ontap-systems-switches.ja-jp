...
summary: Cisco Nexus 9808 スイッチの NX-OS をアップグレードして、AFX 2K システムで新しいハードウェアまたは新しい ONTAP バージョンをサポートします。 
---
= Cisco Nexus 9808スイッチのNX-OSをアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9808 スイッチの NX-OS をアップグレードして、AFX 2K システムで新しいハードウェアまたは新しい ONTAP バージョンをサポートします。
