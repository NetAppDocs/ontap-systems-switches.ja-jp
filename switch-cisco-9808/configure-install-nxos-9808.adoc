...
summary: 新規 AFX 2K システムのインストール、スーパーバイザー モジュールの交換、または工場出荷時設定へのリセットのために、Cisco Nexus 9808 スイッチに NX-OS をインストールします。 
---
= Cisco Nexus 9808スイッチにNX-OSをインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新しい AFX 2K システムのインストール、スーパーバイザー モジュールの交換、またはスイッチを工場出荷時のデフォルト設定にリセットする場合は、Cisco Nexus 9808 スイッチに NX-OS をインストールします。
