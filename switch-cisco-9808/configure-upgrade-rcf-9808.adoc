...
summary: AFX 2K システムで新しいハードウェア、新しい ONTAP バージョン、または新しい NX-OS バージョンをサポートするために、Cisco Nexus 9808 スイッチの RCF をアップグレードします。 
---
= Cisco Nexus 9808 スイッチの RCF をアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9808 スイッチの参照構成ファイル （RCF） をアップグレードして、AFX 2K システムの新しいハードウェア、新しい ONTAP バージョン、または新しい NX-OS バージョンをサポートします。
