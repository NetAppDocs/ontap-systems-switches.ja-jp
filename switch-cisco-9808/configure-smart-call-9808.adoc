...
summary: Cisco Nexus 9808 スイッチで Smart Call Home を設定して、重要なシステムイベントに関する自動メール通知を有効にします。 
---
= Cisco Nexus 9808 スイッチの Smart Call Home を設定する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9808 スイッチで Smart Call Home を設定して、重要なシステムイベントに関する自動メール通知を有効にします。
