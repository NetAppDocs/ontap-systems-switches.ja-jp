...
この手順 の例では 4 つのノードを使用しています。 2 つのノードで 4 つの 10GB のクラスタインターコネクトポートを使用： e0a 、 e0b 、 e0c 、 e0d 。他の 2 つのノードは、それぞれ 4 GB のクラスタ・インターコネクト・ポートを 2 つ使用します。プラットフォームの実際のクラスタポートについては、 Hardware Universe を参照してください。
