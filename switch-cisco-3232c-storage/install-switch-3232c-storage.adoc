...
summary: Cisco Nexus 3232C ストレージスイッチをインストールして、ストレージ ネットワーク運用の準備をします。 
---
= Cisco Nexus 3232C ストレージスイッチのインストール
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 3232C ストレージスイッチをインストールして、ストレージ ネットワーク運用の準備をします。
...
Cisco Nexus 3232C を NetApp システムキャビネットに搭載する
 a| 
スイッチをNetAppキャビネットに設置する手順については、 『Installing a Cisco Nexus 3232C cluster switch and pass-through panel in a NetApp cabinet』 ガイドを参照してください。
...
通信ラック内の機器
 a| 
スイッチハードウェアのインストールガイドおよび NetApp のインストールとセットアップ手順に記載されている手順を参照してください。
