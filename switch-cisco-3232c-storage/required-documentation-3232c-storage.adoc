...
Cisco Nexus 3232C スイッチをセットアップするには、link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/series.html["Cisco Nexus 3000 シリーズ スイッチのサポート"^]から次のドキュメントが必要です。
...
42U システム キャビネットに関連する FRU について説明し、メンテナンスおよび FRU 交換の手順を示します。
 ...
 a| 
link:install-cisco-nexus-3232c-storage.html["NetAppキャビネットにCisco Nexus 3232Cスイッチをインストールする"^]
 a| 
