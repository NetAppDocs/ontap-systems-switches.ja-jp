...
summary: SSH と SSH キーが Cisco Nexus 3232C ストレージ スイッチで有効になっていることを確認し、CSHM およびログ収集をサポートします。 
---
= Cisco Nexus 3232C ストレージスイッチのSSH構成を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
SSH と SSH キーが Cisco Nexus 3232C ストレージスイッチで有効になっていることを確認し、イーサネットスイッチヘルスモニター（CSHM）およびログ収集機能をサポートします。
