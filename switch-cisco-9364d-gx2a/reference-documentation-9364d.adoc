...
summary: AFX 1K および AFX 2K システムにおける Cisco Nexus 9364D-GX2A スイッチの設置およびメンテナンスについては、Cisco スイッチと NetApp システムのドキュメントを参照してください。 
---
= Cisco Nexus 9364D-GX2A スイッチのリファレンス ドキュメントを確認してください
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
AFX 1K および AFX 2K システムにおける Cisco Nexus 9364D-GX2A スイッチの設置、設定、および保守については、該当する Cisco スイッチのドキュメントおよび NetApp システムのドキュメントを参照してください。
