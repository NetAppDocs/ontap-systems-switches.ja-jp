...
summary: Cisco Nexus 9364D-GX2A スイッチの NX-OS をアップグレードして、AFX 1K または AFX 2K システムで新しいハードウェアまたは新しい ONTAP バージョンをサポートします。 
---
= Cisco Nexus 9364D-GX2A スイッチの NX-OS をアップグレードする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9364D-GX2A スイッチの NX-OS をアップグレードして、AFX 1K または AFX 2K システムで新しいハードウェアまたは新しい ONTAP バージョンをサポートします。
...
.次の手順
スイッチの NX-OS をアップグレードしたら、link:configure-install-upgrade-rcf-overview-9364d.html["RCFの概要をインストールまたはアップグレードする"] から始めて RCF をアップグレードします。
