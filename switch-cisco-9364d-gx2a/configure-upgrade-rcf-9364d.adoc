...
summary: Cisco Nexus 9364D-GX2A スイッチのリファレンス構成ファイル（RCF）のバージョンをアップグレードして、新しいハードウェア、新しい ONTAP バージョンのサポート、または AFX 1K や AFX 2K システム構成における新しい NX-OS バージョンへの対応を実現します。 
---
