...
summary: クラスタ ネットワーク内の故障した Nexus 9364d-gx2a スイッチの交換は、システムを停止させることなく実施できる手順です。 
---
= Cisco Nexus 9364D-GX2Aスイッチを交換する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** スイッチの初期カスタマイズは完了しました。詳細はlink:setup-switch-9364d-cluster.html["9364D-GX2Aクラスタスイッチを構成する"]。
+
