...
summary: 新規の AFX 1K または AFX 2K システムのインストール、スイッチの交換、または工場出荷時設定へのリセットを行う場合は、Cisco Nexus 9364D-GX2A スイッチに NX-OS をインストールしてください。 
---
= NX-OS を Cisco Nexus 9364D-GX2A スイッチにインストールする
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新規の AFX 1K または AFX 2K システムのインストール、スイッチの交換、またはスイッチを工場出荷時のデフォルト設定にリセットする場合は、Cisco Nexus 9364D-GX2A スイッチに NX-OS をインストールします。
