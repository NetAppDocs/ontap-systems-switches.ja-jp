...
summary: Cisco Nexus 9364D-GX2A スイッチで Smart Call Home を設定して、重要なシステムイベントに関する自動メール通知を有効にします。 
---
= Cisco Nexus 9364D-GX2A スイッチの Smart Call Home を設定する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 9364D-GX2A スイッチで Smart Call Home を設定して、重要なシステムイベントに関する自動メール通知を有効にします。
