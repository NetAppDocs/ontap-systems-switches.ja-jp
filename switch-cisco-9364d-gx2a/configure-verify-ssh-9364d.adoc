...
summary: 新しい AFX 1K または AFX 2K システムのインストール、スイッチの交換、または工場出荷時の設定へのリセットの一環としてスイッチを構成する場合、イーサネットスイッチヘルスモニター（CSHM）のログ収集機能を使用するには、スイッチで SSH が有効になっていることを確認する必要があります。 
---
= SSHによるログ収集を確認する - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
新しい AFX 1K または AFX 2K システムのインストール、スイッチの交換、または工場出荷時の設定へのリセットの一環としてスイッチを構成する場合、イーサネットスイッチヘルスモニター（CSHM）のログ収集機能を使用するには、スイッチで SSH が有効になっていることを確認する必要があります。
