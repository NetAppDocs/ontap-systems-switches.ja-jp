...
summary: SSH と SSH キーが Cisco Nexus 92300YC クラスタスイッチで有効になっていることを確認し、CSHM とログ収集をサポートします。 
---
= Cisco Nexus 92300YC クラスタスイッチのSSH構成を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 92300YC クラスタスイッチで SSH および SSH キーが有効になっていることを確認し、イーサネットスイッチヘルスモニター（CSHM）およびログ収集機能をサポートします。
