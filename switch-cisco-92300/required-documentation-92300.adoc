...
summary: Cisco Nexus 92300YC クラスタスイッチのインストールとメンテナンスに必要なドキュメントを確認してください。 
---
= Cisco Nexus 92300YC クラスタスイッチのドキュメント要件を確認する
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Cisco Nexus 92300YC クラスタスイッチをセットアップして ONTAP クラスタに設定するために必要なスイッチとコントローラーのドキュメントを確認してください。
...
Cisco Nexus 92300YC スイッチをセットアップするには、link:https://www.cisco.com/site/us/en/products/networking/cloud-networking-switches/nexus-9200-series-switches/index.html["Cisco Nexus 9000 シリーズ スイッチのサポート"^]から次のドキュメントが必要です。
...
Cisco Nexus 92300YC スイッチをNetAppキャビネットに設置するには、次のハードウェアドキュメントを参照してください。
...
42U システム キャビネットに関連する FRU について説明し、メンテナンスおよび FRU 交換の手順を示します。
 ...
 a| 
link:install-switch-netapp-cabinet-92300yc.html["Cisco Nexus 92300YC スイッチを NetApp キャビネットに設置する"]
 a| 
4 ポストの NetApp キャビネットに Cisco Nexus 92300YC スイッチをインストールする方法について説明します。
