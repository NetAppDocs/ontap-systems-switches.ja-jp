...
summary: Cisco Nexus 92300YC クラスタスイッチを設定する前に、設定の概要を確認してください。 
---
= Cisco Nexus 92300YC スイッチのハードウェアインストールワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
92300YCクラスタスイッチのハードウェアをインストールおよび設定するには、次の手順に従ってください。
