...
summary: ONTAP 環境に Cisco Nexus 92300YC クラスタスイッチをインストールして設定するには、このワークフローに従ってください。 
---
= Cisco Nexus 92300YC クラスタスイッチのインストールとセットアップのワークフロー
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
ONTAP 環境に Cisco Nexus 92300YC クラスタスイッチをインストールして設定するには、このワークフローに従ってください。92300YC は、3 ノード以上の ONTAP クラスタをサポートします。

以下のワークフロー手順に従って、Cisco Nexus 92300YC スイッチのインストールとセットアップを行います。
...
[role="quick-margin-para"]
92300YC スイッチと ONTAP クラスタをセットアップするには、特定のスイッチおよびコントローラのドキュメントを参照してください。
