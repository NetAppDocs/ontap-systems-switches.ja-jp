...
Cisco Nexus 92300YC クラスタ スイッチをセットアップおよび構成する方法について説明します。
 ...
 a| 
https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-92300/install-nxos-overview.html["_NX-OSとリファレンス構成ファイル（RCF）のインストール_"^]
 a| 
Nexus 92300YC クラスタ スイッチに NX-OS と参照構成ファイル (RCF) をインストールする方法について説明します。
 ...
 a| 
https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-92300/configure-install-initial.html["_新しいCisco Nexus 92300YCスイッチを構成する_"^]
 a| 
