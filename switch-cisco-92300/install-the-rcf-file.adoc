...
. 以下の転送プロトコル（FTP、TFTP、SFTP、SCP）のいずれかを使用して、RCFファイルをスイッチcs2のbootflashにコピーします。Ciscoコマンドの詳細については、link:https://www.cisco.com/c/en/us/support/switches/nexus-9000-series-switches/series.html#InstallandUpgrade["Cisco Nexus 9000 シリーズ スイッチ"^]の適切なガイドを参照してください。
+
