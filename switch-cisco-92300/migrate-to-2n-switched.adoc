...
---
= Cisco Nexus 92300YC スイッチを使用した2ノードスイッチドクラスタへの移行
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
既存の 2 ノード _スイッチレス_ クラスタ環境がある場合は、Cisco Nexus 92300YC スイッチを使用して 2 ノード _スイッチド_ クラスタ環境に移行することで、クラスタ内のノード数を 2 つ以上に拡張できます。
