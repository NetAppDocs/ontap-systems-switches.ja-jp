...
summary: クラスタネットワーク内の故障したNexus 92300YCスイッチの交換は、システムを停止させることなく実施できる手順です。 
---
= Cisco Nexus 92300YC スイッチの交換
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
クラスタ ネットワーク内で障害が発生したNexus 92300YCスイッチは、無停止（NDU）で交換できます。
