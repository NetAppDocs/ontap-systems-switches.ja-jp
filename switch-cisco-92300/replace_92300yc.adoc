...
+
link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cisco-92300/configure-overview.html["新しい Cisco Nexus 92300YC スイッチを構成します"^]
...
Total entries displayed: 4
----
. ONTAP 9.4 以降では、 gthe コマンドを使用して、スイッチ関連のログファイルを収集するためのクラスタスイッチヘルスモニタログ収集機能を有効にします。
+
